...
export default class Floor {
    ...
    setCircles() {
        ...
        const material = new THREE.MeshStandardMaterial({ color: 0xB880FF });
        const material2 = new THREE.MeshStandardMaterial({ color: 0x6C31C9 });
        const material3 = new THREE.MeshStandardMaterial({ color: 0x2E005E });
